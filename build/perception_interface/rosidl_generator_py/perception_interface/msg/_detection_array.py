...
class Metaclass_DetectionArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from perception_interface.msg import DetectionResult
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'source_image': 'sensor_msgs/Image',
        'model_name': 'string',
        'model_version': 'string',
        'detections': 'sequence<perception_interface/DetectionResult>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['perception_interface', 'msg'], 'DetectionResult')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from sensor_msgs.msg import Image
        self.source_image = kwargs.get('source_image', Image())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.source_image != other.source_image:
            return False
    ...
    def source_image(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'source_image' field must be a sub message of type 'Image'"
