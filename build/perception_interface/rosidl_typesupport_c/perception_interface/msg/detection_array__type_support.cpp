...
static const _DetectionArray_type_support_symbol_names_t _DetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, perception_interface, msg, DetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, perception_interface, msg, DetectionArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, perception_interface, msg, DetectionArray)() {
  return &::perception_interface::msg::rosidl_typesupport_c::DetectionArray_message_type_support_handle;
}
